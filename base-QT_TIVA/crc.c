...
//Array de tipo const, de forma que queda almacenado en la ROM y no en la RAM
static const unsigned short int crctttab[256] =
{
...
unsigned short int create_checksum(unsigned char *paquete,unsigned short int longitud)
{
	...
	{
		tmp=((unsigned char)(checksum>>8))^paquete[i];
		checksum=(checksum<<8)^crctttab[tmp];
	}
	return checksum;
}
