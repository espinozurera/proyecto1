...
uint32_t USBTxHandler(void *pvCBData, uint32_t ui32Event,
                   uint32_t ui32MsgValue, void *pvMsgData)
//unsigned long
//USBTxHandler(void *pvCBData, unsigned long ui32Event, unsigned long ui32MsgValue,
//          void *pvMsgData)
{
	unsigned char cChar;
...
//unsigned long USBRxHandler(void *pvCBData, unsigned long ui32Event, unsigned long ui32MsgValue,
  //        void *pvMsgData)
{
